package com.fiap.postech.pedido_receiver.utils;
...
public class ConstantUtils {
    ...
    public static final String PEDIDO_ITEM_NAO_ENCONTRADO = "Item do pedido não encontrado para o ID do pedido informado.";
